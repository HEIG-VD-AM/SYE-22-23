...
/**
 * Creates a symbolic link between file with file descritor and a new file named
 * `file_name`
 */
int sys_symlink(int fd, const char *pathname);
...
void sys_procname(char *str);

// LEI: 2021_lab02
int sys_fork2(void);

// LEI: 2021_lab06
uint32_t sys_translate(uint32_t vaddr);
